...
IL_0094:
	{
		...
		NullCheck(L_33);
		String_t* L_34;
		L_34 = String_Replace_mD912844A1141FE8771F55255C4A8D29C80C47618(L_33, ((int32_t)44), ((int32_t)46), /*hidden argument*/NULL);
		...
		bool L_36;
		L_36 = Single_TryParse_m889B15D32988B9193049C9B4CCF25E42B4F000A0(L_34, ((int32_t)167), L_35, (float*)(&V_4), /*hidden argument*/NULL);
		if (L_36)
		{
			goto IL_00c0;
		}
...
IL_00d0:
	{
		...
		int64_t L_40 = V_3;
		float L_41 = V_4;
		VideoProperties_t46EFDC70D401885E1747EAAB4B03C0013EDB6A31  L_42;
		memset((&L_42), 0, sizeof(L_42));
		VideoProperties__ctor_m99DEF6303739A1066E891A8C78E0623AEEE25616((&L_42), L_38, L_39, L_40, L_41, /*hidden argument*/NULL);
		return L_42;
	}
}
